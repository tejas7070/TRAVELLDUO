...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
 ...
 <body onload="display_slider()">
    <div class="row topnav">
         <h3 style="margin-left: 40%;margin-top:23px;">TRAVELDUO</h3>
   	</div>
	<div class="container1">
      <ul class="navbar" >
        <li><a href="home.php">Home</a></li>
         ...
         <li><button style="background-color: maroon; border-radius: 15px 15px 15px 15px; margin-left: 100px; margin-top:-2px;"><a href="login.php">Book a ride</a></button></li>
     </ul>
    </div>
