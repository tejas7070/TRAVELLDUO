...
<div class="am_heading">
 ...
 <form method='POST' action='process/registerprocess.php' style="margin:27px; margin-left:500px;" enctype="multipart/form-data">
    ...
    <div class="form-field">
      ...
      <input type="checkbox" name="terms" style="margin-left:-52px;" size="32" required>
    </div>
